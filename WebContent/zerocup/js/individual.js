function firstpageblock(){
	...
	document.getElementById('photowall').style.display="none";
	document.getElementById('footfinger').style.display="none";
...
function photowallblock(){
	document.getElementById('firstpage').style.display="none";
	document.getElementById('Diary').style.display="none";
	document.getElementById('photowall').style.display="block";
	document.getElementById('footfinger').style.display="none";
	document.getElementById('argument').style.display="none";
	document.getElementById('setting').style.display="none"
}
function footfingerblock(){
	document.getElementById('firstpage').style.display="none";
	document.getElementById('Diary').style.display="none";
	document.getElementById('photowall').style.display="none";
	document.getElementById('footfinger').style.display="block";
	document.getElementById('argument').style.display="none";
	document.getElementById('setting').style.display="none"
}
